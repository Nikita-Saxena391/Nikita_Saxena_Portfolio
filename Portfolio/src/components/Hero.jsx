...
const Hero = () => {
     ...
     <section id="home" className=" min-h-screen flex items-center justify-center text-center">
          <div className="relative z-10 container mx-auto px-6">
               ...
               <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold mb-2 text-black dark:text-white">
                    Hi, I'm <span className="bg-gradient-to-r from-purple-800 to-purple-500 text-transparent bg-clip-text">Nikita Saxena</span>
               </h1>
               <TypeAnimation sequence={['A Full-Stack Developer', 2000, 'A Problem Solver', 2000]} wrapper="h2" speed={50} className="text-xl sm:text-2xl md:text-4xl font-semibold mb-6 mt-4 text-gray-800 dark:text-gray-200" repeat={Infinity} />
  ...
  <motion.button
    ...
    className="px-8 py-3 w-full sm:w-auto rounded-full font-semibold border-2 border-purple-600 text-purple-700 dark:text-purple-400 dark:border-purple-400 transition-all duration-300 hover:bg-purple-100/40 dark:hover:bg-purple-400/10"
  ...
  <motion.a
    href="mailto:nikitasaxena.net@gmail.com" // replace with your email or link
    className="px-8 py-3 w-full sm:w-auto rounded-full font-semibold border-2 border-purple-600 text-purple-700 dark:text-purple-400 dark:border-purple-400 transition-all duration-300 hover:bg-purple-100/20 dark:hover:bg-purple-400/10 text-center"
    whileHover={{ scale: 1.05 }}
    whileTap={{ scale: 0.95 }}
    data-interactive
  >
