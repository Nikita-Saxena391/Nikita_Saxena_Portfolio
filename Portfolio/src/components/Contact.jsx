...
const Contact = () => {
  ...
  const socialContactLinks = [
    { href: 'mailto:nikitasaxena.net@gmail.com', icon: FaEnvelope, label: 'nikitasaxena.net@gmail.com', hoverColor: 'hover:text-purple-500 dark:hover:text-purple-400', target: '', },
    { href: 'https://wa.me/7217361314', icon: FaWhatsapp, label: '+91 7217361314', hoverColor: 'hover:text-green-500 dark:hover:text-green-400', target: '_blank', },
  ...
  const sendEmail = (e) => {
    ...
    const serviceID = import.meta.env.VITE_EMAILJS_SERVICE_ID;       // service_i8sn3br
    const templateID = import.meta.env.VITE_EMAILJS_TEMPLATE_ID;     // template_vdiesrl
    const publicKey = import.meta.env.VITE_EMAILJS_PUBLIC_KEY;       // Na23CERYe6em4Yz_M

    if (!serviceID || !templateID || !publicKey) {
      console.error("EmailJS credentials are missing or invalid.");
      setStatus('error');
